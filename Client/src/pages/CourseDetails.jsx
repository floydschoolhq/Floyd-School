    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-black text-white selection:bg-blue-600 selection:text-white relative font-['Outfit']">
            ...
            <div className="relative z-20">
                ...
                {/* Technical Excellence & Career Support Section (300-500 words for SEO) */}
                <LocalizedSEOSection 
                    title="Technical Excellence"
                    highlight="& Career Support"
                    dark={true}
                    paragraphs={[
                        `The Thinkskool advantage for ${course.title} is built on a foundation of industrial relevance and expert mentorship. We understand that mastering modern technologies requires more than just watching tutorials; it requires a deep dive into the architectural principles that govern high-performance systems. Our curriculum is architected to take you from foundational concepts to production-scale mastery, ensuring you are equipped with the skills demanded by top-tier global tech firms.`,
                        "Every module in this specialization track is designed to mimic real-world engineering challenges. You will work with industrial-grade tools, follow standard security protocols, and learn to optimize your code for scalability and performance. This 'Production-First' approach ensures that the projects in your portfolio are not just academic exercises, but are representative of the high-intensity work performed in the industry.",
                        "Mentorship is the cornerstone of our pedagogy. Throughout the program, you will have direct access to experienced engineers who have built and deployed systems at scale. This personalized guidance includes detailed code reviews, architectural feedback, and career coaching, helping you navigate the complexities of the modern tech landscape with confidence. We focus on 'First Principles Thinking,' teaching you not just how to use current libraries, but how to understand the underlying logic to adapt to future technologies.",
                        "Our commitment to your career goes beyond technical training. We provide comprehensive support in building a world-class engineering portfolio, preparing for technical interviews, and connecting with our network of innovative partner companies. With a 100% deployment rate for our advanced tracks, we pride ourselves on being the definitive launchpad for your professional journey in the tech industry."
                    ]}
                />
