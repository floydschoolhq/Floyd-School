import { BookOpen, LogIn, LogOutIcon } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-800">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex items-center justify-center space-x-3 pb-4">
            ...
            <h3 className="text-2xl font-bold text-white">Mentor Login</h3>
          </div>
          ...
          >
            {isSubmitting ? (
              ...
              <><LogIn className="w-5 h-5" /> Log In as Mentor</>
            )}
          </button>
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-slate-400">
              ...
              <Link to="/mentor/signup" className="text-emerald-400 font-semibold hover:text-emerald-300 hover:underline">
                Sign Up
              </Link>
            </p>
          </div>
