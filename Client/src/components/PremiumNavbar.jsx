                    ...
                    <div className="w-full max-w-7xl flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            ...
                            <motion.button
                                ...
                                className="group relative px-6 py-3 bg-white text-slate-700 font-semibold rounded-xl hover:bg-slate-50 transition-all duration-300 shadow-lg hover:shadow-xl border border-slate-200"
                            >
                                ...
                                <div className={`p-4 border-t ${isCoursesPage ? 'border-slate-700' : 'border-slate-200'}`}>
                                    <div className="space-y-3">
                                        ...
                                        <motion.button
                                            ...
                                            className={`w-full py-3 font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl border relative overflow-hidden group
                                                ${isCoursesPage 
