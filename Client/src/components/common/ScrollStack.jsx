...
const ScrollStack = ({
  ...
  const cardOffsetsRef = useRef([]); // Stable offsets to prevent feedback loops
  ...
  useLayoutEffect(() => {
    ...
    // Re-calculate on resize/layout shift
    ...
    const timers = [
      ...
      setTimeout(recalculateOffsets, 300), // Catch end of expansion animations
      setTimeout(recalculateOffsets, 1000)
    ];
