...
const AI_REVIEWS = [
    {
        ...
        content:
            <>The way <span className="font-bold tracking-tight lowercase"><span className="text-[#2563EB]">think</span><span className="text-[#F97316]">skool</span></span> breaks down gradient descent and backpropagation is unlike anything I've seen. I went from basic Python to deploying my own image classifier in 8 weeks. The mentors are absolutely brilliant—they actually work in AI labs, not just teach from a textbook.</>,
    ...
    },
    {
        ...
        content:
            <>I'd tried 3 other online AI courses before <span className="font-bold tracking-tight lowercase"><span className="text-[#2563EB]">think</span><span className="text-[#F97316]">skool</span></span> and none came close. The curriculum is ridiculously industry-focused—we worked on actual NLP pipelines and recommendation systems. Within a month of finishing, I had 4 interview calls. Now I'm at Razorpay as a full-time Data Scientist!</>,
    ...
    },
    {
        ...
        content:
            <>I'm not a pure coder, but I wanted to understand AI deeply enough to lead ML teams. <span className="font-bold tracking-tight lowercase"><span className="text-[#2563EB]">think</span><span className="text-[#F97316]">skool</span></span>'s approach of explaining the 'why' behind every model made it perfect for me. The reinforcement learning section opened my eyes to robotics and game AI. Now I confidently run sprint planning for AI features.</>,
    ...
    },
    {
        ...
        content:
            <>As a defence research fellow, I needed advanced ML skills specifically in NLP and LLMs. The <span className="font-bold tracking-tight lowercase"><span className="text-[#2563EB]">think</span><span className="text-[#F97316]">skool</span></span> AI program covered fine-tuning LLaMA models, RAG pipelines, and inference optimization—stuff you'd normally only find in research papers. The 1-on-1 mentor sessions gave me direction I couldn't get elsewhere.</>,
