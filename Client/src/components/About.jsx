  ...
  return (
    <div className="min-h-screen bg-[#FCF8F8] py-32 relative overflow-hidden font-['Inter']" id="about">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-[#F5AFAF]/5 rounded-full blur-[120px] animate-pulse"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-12 relative z-10">
        ...
        >
          <span className="text-[#F5AFAF] font-black uppercase tracking-[0.4em] text-[10px] mb-6 font-['Outfit'] block">ThinkSkool Philosophy</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            <GlowingCard containerClassName="rounded-[3.5rem]" className="rounded-[3rem]">
              <div className="h-full flex flex-col items-center text-center p-10 lg:p-16 relative overflow-hidden">
                {/* Accent Glow */}
                <div className="absolute -top-24 -right-24 w-64 h-64 bg-[#F5AFAF]/5 rounded-full blur-3xl group-hover:bg-[#F5AFAF]/10 transition-colors duration-700" />
                ...
                <div className="w-32 h-32 rounded-[2.5rem] bg-white/5 backdrop-blur-md flex items-center justify-center mb-10 border border-white/10 shadow-3xl transition-all duration-700 group-hover:rotate-6 group-hover:scale-110">
                  <FaSchool className="text-6xl text-slate-100 opacity-80 group-hover:opacity-100 group-hover:text-[#F5AFAF] transition-all" />
                </div>

                <h3 className="text-4xl lg:text-5xl font-black text-white mb-8 font-['Outfit'] tracking-tight">For <span className="text-[#F5AFAF]">Schools</span></h3>

                <p className="text-xl text-slate-400 mb-10 leading-relaxed font-medium">
                  Seamlessly integrated into your daily curriculum to eliminate all scheduling friction.
                  <span className="block mt-6 text-[#F5AFAF] font-black uppercase tracking-[0.2em] text-[11px] font-['Outfit']">THINKSKOOL HANDLES THE TECH.</span>
                </p>
          ...
          >
            <GlowingCard containerClassName="rounded-[3.5rem]" className="rounded-[3rem]">
              <div className="h-full flex flex-col items-center text-center p-10 lg:p-16 relative overflow-hidden">
                {/* Accent Glow */}
                <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-[#F5AFAF]/5 rounded-full blur-3xl group-hover:bg-[#F5AFAF]/10 transition-colors duration-700" />

                <div className="w-32 h-32 rounded-[2.5rem] bg-[#F5AFAF]/10 backdrop-blur-md flex items-center justify-center mb-10 border border-[#F5AFAF]/20 shadow-3xl transition-all duration-700 group-hover:-rotate-6 group-hover:scale-110">
                  <FaUserGraduate className="text-6xl text-[#F5AFAF] drop-shadow-[0_0_15px_rgba(245,175,175,0.4)]" />
                </div>

                <h3 className="text-4xl lg:text-5xl font-black text-slate-100 mb-8 font-['Outfit'] tracking-tight">For <span className="text-[#F5AFAF]">Students</span></h3>

                <p className="text-xl text-slate-400 mb-10 leading-relaxed font-medium">
                  Forge professional skills in AI, Robotics, and Architecture.
                  <span className="block mt-6 text-[#F5AFAF] font-black uppercase tracking-[0.2em] text-[11px] font-['Outfit']">BUILD CREATORS, NOT CONSUMERS.</span>
                </p>
