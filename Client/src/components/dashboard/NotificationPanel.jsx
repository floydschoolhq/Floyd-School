    ...
    return (
        <div className="relative">
            ...
            >
                ...
                {unreadCount > 0 && (
                    <span className="absolute -top-1 -right-1 bg-[#fca96d] text-white text-[10px] rounded-full w-5 h-5 flex items-center justify-center font-bold">
                            ...
                            <div className="flex items-center gap-2">
                                {unreadCount > 0 && (
                                    <button
                                        ...
                                        className="text-xs font-bold text-[#fca96d] hover:underline"
                                    >
                                        Mark all read
                                    </button>
                                )}
                                    ...
                                    >
                                        <div className="flex items-start gap-4">
                                            <div className={cn(
                                                ...
                                                !notification.isRead ? "bg-[#fca96d]" : "bg-slate-200"
                                            )} />
                                            ...
                                            {!notification.isRead && (
                                                <div className="flex items-center justify-center w-6 h-6 rounded-full bg-[#fca96d]/10">
                                                    <Check className="w-3 h-3 text-[#fca96d]" />
                                                </div>
                                            )}
                                        </div>
                                    </motion.div>
