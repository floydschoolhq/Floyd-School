        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg text-slate-300 mb-6 leading-relaxed max-w-xl lg:max-w-none mx-auto lg:mx-0 font-medium">
              <span className="text-[#2563EB] font-black tracking-tighter">floyd</span><span className="text-[#F97316] font-black tracking-tighter">school</span> is a school-integrated STEM education program designed to make
