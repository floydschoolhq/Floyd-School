        ...
        <div className="mt-12 space-y-8">
            ...
            <form onSubmit={handleSubmit} className="relative group">
                <textarea
                    ...
                    className="w-full bg-white border-2 border-slate-100 rounded-3xl p-6 pr-20 text-base font-medium outline-none focus:border-[#2563EB] transition-all shadow-xl shadow-slate-200/20 min-h-[120px] resize-none"
                    onKeyPress={(e) => {
                ...
                <button
                    ...
                    className="absolute right-4 bottom-4 bg-[#2563EB] text-white p-4 rounded-2xl shadow-lg shadow-[#2563EB]/30 hover:scale-105 active:scale-95 transition-all disabled:opacity-50"
                >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-6">
                                        {comment.status === 'resolved' ? (
                                            ...
                                            <button className="flex items-center gap-2 text-[13px] font-black text-slate-400 hover:text-[#2563EB] uppercase tracking-widest transition-colors">
