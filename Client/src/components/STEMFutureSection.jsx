...
const NewWayInfographic = () => (
    <div className="relative w-72 h-72 flex items-center justify-center">
        ...
        <motion.div
            ...
            className="absolute inset-4 border border-[#2563EB]/10 rounded-full"
        />
                ...
                >
                    ...
                    <div className="relative w-full lg:w-px flex lg:flex-col items-center justify-center -my-px z-30 pointer-events-none">
                        ...
                        <div className="absolute inset-0 pointer-events-none">
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[2px] h-full bg-gradient-to-b from-transparent via-[#2563EB]/30 to-transparent" />
                        </div>
                    </div>
                    ...
                    <div className="flex-1 relative p-10 lg:p-16 flex flex-col bg-white z-10 overflow-hidden shadow-[inset_60px_0_150px_rgba(245,175,175,0.02)]">
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-10">
                                    {["Cloud First", "AI Built", "Support"].map((tag, i) => (
                                        <ValueTag key={i} text={tag} color="bg-[#2563EB]" />
                                    ))}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-to-br from-[#2563EB]/5 to-blue-500/5 rounded-full blur-[120px] -z-10" />
                    </div>
                </motion.div>
