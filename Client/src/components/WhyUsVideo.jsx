    ...
    return (
        <section className="bg-slate-50 py-24 relative overflow-hidden font-['Inter']">
            ...
            <div className="absolute top-10 left-0 right-0 flex justify-center pointer-events-none select-none overflow-hidden">
                <h1 className="text-[12rem] md:text-[18rem] font-extrabold text-transparent stroke-text opacity-5 whitespace-nowrap"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-20 animate-fade-in-up">
                    <p className="text-[#2563EB] font-bold uppercase tracking-[0.4em] text-[10px] mb-4">Evolution of Learning</p>
                    <h2 className="text-5xl md:text-6xl font-extrabold text-slate-900 tracking-tighter mb-4">
                ...
                <div className="flex flex-col md:flex-row items-stretch justify-center gap-0 md:gap-0 relative">
                    ...
                    <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-16 h-16 bg-white rounded-full items-center justify-center shadow-xl border border-slate-100">
                        <span className="font-extrabold text-slate-900 italic text-xl">VS</span>
                    </div>
                    ...
                    >
                        ...
                        <div className="mb-10">
                            <span className="inline-block px-4 py-1 rounded-full bg-slate-100 text-slate-500 text-[10px] font-bold uppercase tracking-widest mb-4">Traditional Model</span>
                            <h3 className="text-3xl font-extrabold text-slate-400 mb-2">Passive <span className="opacity-50">Learning</span></h3>
                            <div className="flex gap-4 mt-6">
                                <div className="px-6 py-3 bg-slate-100 rounded-2xl border border-slate-200">
                                    <span className="block text-2xl font-extrabold text-slate-400">12%</span>
                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Engagement</span>
                                </div>
                                <div className="px-6 py-3 bg-slate-100 rounded-2xl border border-slate-200">
                                    <span className="block text-2xl font-extrabold text-slate-400">00%</span>
                        ...
                        <div className="space-y-6">
                            {comparisonFeatures.map((item, idx) => (
                                <div key={idx} className="flex items-center gap-4 group/item opacity-60 hover:opacity-100 transition-opacity">
                                    ...
                                    <div>
                                        <p className="font-bold text-slate-500 text-sm uppercase tracking-wide decoration-slate-300 decoration-2">{item.traditional}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="mb-10">
                            ...
                            <div className="flex gap-4 mt-6">
                                <div className="px-6 py-3 bg-white rounded-2xl border border-[#2563EB]/20 shadow-lg shadow-[#2563EB]/5">
                                    <span className="block text-2xl font-extrabold text-[#2563EB]">95%</span>
                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Retention</span>
                                </div>
                                <div className="px-6 py-3 bg-white rounded-2xl border border-[#2563EB]/20 shadow-lg shadow-[#2563EB]/5">
                                    <span className="block text-2xl font-extrabold text-[#2563EB]">12X</span>
                        ...
                        <div className="space-y-6 relative z-10">
                            {comparisonFeatures.map((item, idx) => (
                                <div key={idx} className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="font-bold text-slate-900 text-sm uppercase tracking-wide">{item.stem}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
