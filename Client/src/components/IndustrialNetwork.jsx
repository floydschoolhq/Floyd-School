                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <motion.div
                            ...
                            className="group flex flex-col items-center text-center gap-6 p-10 rounded-[3rem] bg-white border border-[#FBEFEF] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_40px_80px_-20px_rgba(245,175,175,0.15)] hover:border-[#F5AFAF]/20 transition-all duration-500"
                        >
                            <div className="w-16 h-16 rounded-2xl bg-[#FCF8F8] flex items-center justify-center text-[#F5AFAF] shadow-inner group-hover:bg-[#F5AFAF] group-hover:text-white transition-all duration-300">
                                {item.icon}
                            </div>
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-[10px] font-bold text-[#F5AFAF] uppercase tracking-widest mt-2">Tier-1 Partner Network</span>
                            </div>
