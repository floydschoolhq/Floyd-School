...
const MainLayout = () => {
  ...
  const navItems = [
    ...
    { label: 'Lab Materials & Guides', path: '/learning', icon: Cpu },
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans antialiased flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-white border-b border-slate-200 text-slate-900 px-4 sm:px-6 py-2.5 flex items-center justify-between shadow-2xs">
        ...
        <div className="flex items-center space-x-2.5">
          <button
            ...
            className="hidden sm:flex items-center space-x-1.5 px-2.5 py-1 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded text-xs text-slate-700 font-medium transition-colors"
            title="View Student ID Pass"
          >
            <CreditCard size={13} />
            <span>ID Card</span>
          </button>
          ...
          <button
            ...
            className="p-1.5 text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded border border-slate-200 transition-all relative"
            title="Notifications"
          >
            <Bell size={16} />
          </button>
          ...
          <div className="hidden sm:flex items-center space-x-2 px-3 py-1 bg-slate-100 border border-slate-200 rounded text-xs">
            ...
            <span className="font-mono text-slate-800 text-[11px]">Roll: {user?.offlineRollNo || 'Pending Allotment'}</span>
          </div>
          ...
          <div className="flex items-center space-x-2 pl-2 border-l border-slate-200">
            ...
            >
              <p className="text-xs font-bold text-slate-900 leading-tight hover:underline">{user?.name || 'Student Name'}</p>
      ...
      {/* Notifications and ID Card Modals */}
      <NotificationModal
